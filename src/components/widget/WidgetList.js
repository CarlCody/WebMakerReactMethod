        ...
        return (
            <div>
                <nav className="nav-bar fixed-top navbar-light bg-light">
                    <a href="../page/page-list.js"><i className="fas fa-chevron-left"></i></a>

                    <span className="navbar-brand mb-0 h1">Widgets</span>
                    <a href="widget-chooser.js"><i className="fas fa-plus-square float-right"></i></a>
                </nav>
                <div className="container-fluid">
                    <div>
                        <div className="float-right">
                            <a href="widget-heading.js"><i className="fas fa-cog"></i></a>
                    ...
                    <div>
                        <div className="float-right">
                            <a href="widget-image.js"><i className="fas fa-cog"></i></a>
                            <i className="fas fa-bars"></i>
                        </div>
                ...
                snooze ya lose. <a href="www.mintmovies.net"> For free movies follow this link.</a></p>
                    ...
                    cartoons. Please also subscibe to my youtube channel and remember to stay positive.</p>
                        ...
                        <nav className="navbar navbar-light bg-light fixed-bottom">
                            ...
                            <a href="../user/login.html"><i className="fas fa-users"></i></a>
                        </nav>
                    </div>
                    </div>
                    </div>
